var CE4SchoolSdk = (function (exports,citySdk) {
	'use strict';
	...
	if (!$Number(' 0o1') || !$Number('0b1') || $Number('+0x1')) {
	  $Number = function Number(value) {
	    ...
	    }) : _cof(that) != NUMBER$1) ? _inheritIfRequired(new Base(toNumber(it)), that, $Number) : toNumber(it);
	  };
	...
	if (_descriptors && (!CORRECT_NEW || _fails(function () {
	  ...
	  for (var keys$1 = gOPN$2(Base$1), i = 0; keys$1.length > i;) {
	    proxy(keys$1[i++]);
	  }
	...
	var $at$1 = _stringAt(true); // 21.1.3.27 String.prototype[@@iterator]()
	...
	var entitiesbasepath = "/v2/entities/"; // const attributepath = "/attrs";
	...
	/*#__PURE__*/
	function (_Orion) {
	  _inheritsLoose(Orion4School, _Orion);

	  function Orion4School(protocol, host, port) {
	    if (protocol === void 0) {
	      protocol = Orion4SchoolConfiguration.PROTOCOL;
	    }

	    if (host === void 0) {
	      host = Orion4SchoolConfiguration.HOST;
	    }

	    if (port === void 0) {
	      port = Orion4SchoolConfiguration.PORT;
	    }

	    return _Orion.call(this, protocol, host, port) || this;
	  }

	  var _proto = Orion4School.prototype;

	  _proto.getEntities = function getEntities(fiwareservice, fiwareservicepath, filterparams) {
	    var _this = this;
	    ...
	    return new Promise(function (resolve, reject) {
	      ...
	      if (filterparams) {
	        querystring = _this.queryParams2URI(filterparams);
	      }

	      var url = _this.getBaseUrl() + entitiesbasepath + querystring;
	  ...
	  _proto.getCompanies = function getCompanies(fiwareservice, fiwareservicepath, count) {
	    var filterparams = {
	      idPattern: "Company",
	      limit: count || 1000
	    }; // let filterparams = {limit: count || 1000 };

	    return this.getEntities(fiwareservice, fiwareservicepath, filterparams);
	  };

	  _proto.getCourses = function getCourses(fiwareservice, fiwareservicepath, count) {
	    var filterparams = {
	      idPattern: "Course",
	      limit: count || 1000
	    };
	  ...
	  _proto.getInternships = function getInternships(fiwareservice, fiwareservicepath, count) {
	    var filterparams = {
	      idPattern: "Internship",
	      limit: count || 1000
	    };
	    return this.getEntities(fiwareservice, fiwareservicepath, filterparams);
	  };

	  _proto.getInstitutes = function getInstitutes(fiwareservice, fiwareservicepath, count) {
	    var filterparams = {
	      idPattern: "Institute",
	      limit: count || 1000
	    };
	  ...
	  _proto.queryParams2URI = function queryParams2URI(queryParams) {
	    var urlComponent = '?';
	...
	exports.setCORSHelper = citySdk.setCORSHelper;
	exports.Orion4School = Orion4School;
